...
INSERT INTO tb_task_list (title, inclusion_Date, expiration_Date, status, user_id) VALUES ('Exams', NOW(), TIMESTAMP WITH TIME ZONE '2023-10-10T10:00:00Z', 1, 1);
INSERT INTO tb_task_list (title, inclusion_Date, expiration_Date, status, user_id) VALUES ('household bills', NOW(), TIMESTAMP WITH TIME ZONE '2023-09-20T15:00:00Z', 1, 1);
INSERT INTO tb_task_list (title, inclusion_Date, expiration_Date, status, user_id) VALUES ('Christmas gift for son', NOW(), TIMESTAMP WITH TIME ZONE '2023-12-24T15:00:00Z', 1, 1); 

INSERT INTO tb_task (name, description, status, task_list_id) VALUES ('Rice', 'Rice for lunch', 0, 1);
INSERT INTO tb_task (name, description, status, task_list_id) VALUES ('study math', 'Mathematics test on 10/10', '1', 2); 
INSERT INTO tb_task (name, description, status, task_list_id) VALUES ('Pay electricity', 'pay the electricity bill', '1', 3); 
INSERT INTO tb_task (name, description, status, task_list_id) VALUES ('Pay water', 'pay the water bill', '1', 3); 
